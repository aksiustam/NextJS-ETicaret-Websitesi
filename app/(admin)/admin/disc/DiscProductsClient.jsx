    ...
    setProductData((prevProductData) => {
      ...
      const updatedProductData = prevProductData.map((item, index) => {
        if (item.id === id) {
          ...
          return {
            ...item,
            inprice: item.price - item.price * (parseInt(disc.indirim1) / 100),
    ...
    setProductData((prevProductData) => {
      ...
      const updatedProductData = prevProductData.map((item, index) => {
        if (item.id === id) {
          ...
          return {
            ...item,
            inprice: item.price - item.price * (parseInt(disc.indirim2) / 100),
    ...
    setProductData((prevProductData) => {
      ...
      const updatedProductData = prevProductData.map((item, index) => {
        if (item.id === id) {
          ...
          return {
            ...item,
            inprice: item.price - item.price * (parseInt(disc.indirim3) / 100),
