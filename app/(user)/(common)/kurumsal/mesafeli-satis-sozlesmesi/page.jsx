        ...
        <div className="container-x mx-auto">
          ...
          <div className="content-item w-full mb-10">
            ...
            <p className="text-[15px] text-qgraytwo leading-7 mb-10">
              <strong>Ünvanı:</strong> Bıçakcı Serkan
              <br />
              <strong>Adresi:</strong> Erenler, Kazdağı Sk. 7bb, 42050
              Karatay/Konya
              <br />
              <strong>Telefon:</strong> +90 506 246 27 17
              <br />
              <strong>E-posta:</strong> serkansenol1453@gmail.com
            </p>
            <div>
              <h2 className="text-[18px] font-medium text-qblack mb-5">
            ...
            <div>
              ...
              <p className="text-[15px] text-qgraytwo leading-7 mb-4">
                7.1. Cayma hakkının kullanılması için 14 (ondört) günlük süre
                içinde Satıcı&apos;ya iadeli taahhütlü posta, faks veya eposta
                ile yazılı bildirimde bulunulması ve ürünün işbu sözleşmede
              ...
              <p className="text-[15px] text-qgraytwo leading-7 mb-4">
                7.1.1. 3.kişiye veya Alıcı’ya teslim edilen ürünün faturası
              </p>
              <p className="text-[15px] text-qgraytwo leading-7 mb-4">
                7.2. İade formu,
              </p>
              <p className="text-[15px] text-qgraytwo leading-7 mb-4">
                7.2.1 İade edilecek ürünlerin kutusu, ambalajı, varsa standart
                aksesuarları ile birlikte eksiksiz ve hasarsız olarak teslim
                edilmesi gerekmektedir.
              </p>
              <p className="text-[15px] text-qgraytwo leading-7 mb-4">
                7.2.2 Satıcı, cayma bildiriminin kendisine ulaşmasından itibaren
                10 gün içinde ilgili ürün bedelini Alıcı&apos;ya iade eder ve 20
                günlük süre içinde ürünü iade alır.
              </p>
              <p className="text-[15px] text-qgraytwo leading-7 mb-4">
                7.2.3 Alıcı’nın kusurundan kaynaklanan bir nedenle ürünün
                değerinde bir azalma olursa veya iade imkânsızlaşırsa Alıcı
                kusuru oranında Satıcı’nın zararlarını tazmin etmeyi kabul eder.
                Ancak cayma hakkı süresi içinde ürünün usulüne uygun
                kullanılması sebebiyle meydana gelen değişiklik ve bozulmalardan
                Alıcı sorumlu değildir.
              </p>
              <p className="text-[15px] text-qgraytwo leading-7 mb-4">
                7.2.4 Cayma hakkının kullanılması nedeniyle Satıcı tarafından
            ...
            <div>
              <h2 className="text-[18px] font-medium text-qblack mb-5">
                9. Ürünlerin Kullanımı ve Sorumluluk
              </h2>
              <p className="text-[15px] text-qgraytwo leading-7 mb-4">
                9.1. Satıcı tarafından satılan bıçaklar, süs ve hediyelik eşya
                olarak veya sadece avcılık, kampçılık gibi zararlı olmayacak
                durumlarda kullanılmak üzere tasarlanmıştır.
              </p>
              <p className="text-[15px] text-qgraytwo leading-7 mb-4">
                9.2. Alıcı, satın aldığı bıçağı sadece belirtilen kullanım
                amaçları doğrultusunda kullanacağını kabul, beyan ve taahhüt
                eder.
              </p>
              <p className="text-[15px] text-qgraytwo leading-7 mb-4">
                9.3. Alıcı, satın aldığı bıçağı yasal olmayan amaçlarla
                kullanmayacağını ve bu konuda tüm sorumluluğun kendisine ait
                olduğunu kabul eder.
              </p>
              <p className="text-[15px] text-qgraytwo leading-7 mb-4">
                9.4. Alıcı, bıçağın üçüncü kişiler tarafından zararlı amaçlarla
                kullanılmasından doğabilecek tüm yasal ve cezai sorumlulukların
                kendisine ait olduğunu kabul eder.
              </p>
              <p className="text-[15px] text-qgraytwo leading-7 mb-4">
                9.5. Satıcı, bıçakların yanlış veya yasal olmayan amaçlarla
                kullanılmasından doğabilecek herhangi bir zarardan sorumlu
                değildir. Bu tür kullanımlardan doğabilecek tüm yasal ve cezai
                sorumluluk Alıcı&apos;ya aittir.
              </p>
              <p className="text-[15px] text-qgraytwo leading-7 mb-4">
                9.6. Resmi bir soruşturma veya bıçakla alakalı herhangi bir
                olayda Satıcı, hiçbir şekilde sorumluluk kabul etmez ve Alıcı,
                bu tür durumlarda tüm sorumluluğun kendisine ait olduğunu kabul
                eder.
              </p>
            </div>
