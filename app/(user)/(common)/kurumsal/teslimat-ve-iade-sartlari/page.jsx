        ...
        <div className="container-x mx-auto">
          <div className="content-item w-full mb-10">
            <p className="text-[15px] text-qgraytwo leading-7 mb-4">
              ...
              aldığınız ürünler, sipariş tarihinden itibaren 3 iş günü içinde
              kargoya verilir. Teslimat süresi, kargo şirketinin yoğunluğuna ve
              teslimat adresine göre değişiklik gösterebilir. Ürününüzü teslim
              alırken paketi kontrol ediniz. Hasar görmüş paketleri teslim
              almadan önce kargo yetkilisine tutanak tutturarak geri gönderiniz.
              Ürün teslim alındıktan sonra, herhangi bir hasar durumunda
              sorumluluk müşteriye aittir. Teslimat sırasında yaşanan gecikmeler
              veya problemler için lütfen telefon numaramızdan veya mailden
              iletişime geçiniz.
            </p>
