    ...
    <>
      <div className="grid grid-cols-2 gap-[30px]">
        <div className="w-full bg-primarygray p-5 border">
          <div className="flex justify-between items-center">
            <p className="title text-[22px] font-semibold">Adress #1</p>
            <button
              type="button"
        ...
        <div className="w-full bg-primarygray p-5 border">
          <div className="flex justify-between items-center">
            <p className="title text-[22px] font-semibold">Adress #2</p>
            <button
              type="button"
              className="border border-qgray w-[34px] h-[34px] rounded-full flex justify-center items-center"
            >
      ...
      <div className="w-[180px] h-[50px] mt-4">
        <button type="button" className="yellow-btn">
          <div className="w-full text-sm font-semibold">Yeni Adress Ekle</div>
        </button>
      </div>
    </>
  );
